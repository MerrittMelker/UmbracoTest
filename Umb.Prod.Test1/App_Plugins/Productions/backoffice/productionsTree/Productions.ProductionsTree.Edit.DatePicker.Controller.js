angular.module("umbraco").controller("productions.ProductionDateTimeController", dateTimePickerController);
function dateTimePickerController($scope, notificationsService, assetsService, angularHelper, userService, $element) {
    ...
    userService.getCurrentUser().then(function (user) {
        ...
        assetsService.loadCss('~/umbraco/lib/datetimepicker/bootstrap-datetimepicker.min.css').then(function () {
            var filesToLoad = ["~/umbraco/lib/datetimepicker/bootstrap-datetimepicker.min.js"];
            ...
            if (_.contains(customLangs, user.locale)) {
                ...
                filesToLoad.push("~/umbraco/lib/datetimepicker/langs/datetimepicker." + user.locale + ".js");
            }
