angular.module("umbraco").controller("Productions.ProductionCreateController",
function ($scope, $routeParams, $http, assetsService, productionResource, notificationsService, navigationService, dialogService, entityResource, angularHelper) {
    ...
    if ($routeParams.id == -1) {
        ...
        productionResource.getById($routeParams.id).then(function (response) {
            ...
            $scope.production.StartDate = response.data.EndDate;
            $scope.loaded = true;
            initAssets();
        });
    }
        ...
        .then(function () {
            ...
            assetsService
                ...
                .then(function () {
                    ...
                    $('#datetimepicker1').datetimepicker({ language: 'en' });
